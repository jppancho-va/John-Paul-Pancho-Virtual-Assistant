    ...
    <div className="tools wrap">
      ...
      <div className="marquee-stage-flat">
        <div className="mqwrap-flat">
          <div className="mqtrack-flat">
            {allTools.map((tool, i) => (
              <span key={i} className="mpill-flat">
      ...
      <style jsx global>{`
        ...
        .mqtrack-flat {
          ...
          width: max-content;
          gap: 1.5rem;
          animation: marqueeFlatScroll 35s linear infinite;
        }

        /* PAUSE / SLOW DOWN INTERACTION ON HOVER */
        .mqtrack-flat:hover {
